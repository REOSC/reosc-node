...
usage! {
	...
	}
	{
		...
		["Operating Options"]
			...
			ARG arg_chain: (String) = "reosc", or |c: &Config| c.parity.as_ref()?.chain.clone(),
			"--chain=[CHAIN]",
			"Specify the blockchain type. CHAIN may be either a JSON chain specification file or reosc, ethereum, classic, poacore, tobalaba, expanse, musicoin, ellaism, easthub, social, reosc, olympic, morden, ropsten, kovan, poasokol, testnet, or dev.",
