...
usage! {
	...
	}
	{
		...
		["Operating Options"]
			...
			"--chain=[CHAIN]",
			"Specify the blockchain type. CHAIN may be either a JSON chain specification file or ethereum, classic, poacore, tobalaba, expanse, musicoin, ellaism, easthub, social, reosc, olympic, morden, ropsten, kovan, poasokol, testnet, or dev.",
